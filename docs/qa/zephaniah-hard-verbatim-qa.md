# Verbatim-Text QA — Zephaniah, Hard Tier (World 36)

Per `QA_REQUIREMENTS.md` §3. Independent re-verification of every challenge-ready verse in
`docs/content/zephaniah-hard.md`, run 2026-09-03, after theological review
(`docs/reviews/zephaniah-hard-review.md`, `approved`, no changes required).
...
verse verbatim and boss item 8 is a reference-order/matching sequence over already-checked verses
with no new quoted text).
...
| 3 | Zeph 2:3 | "Seek Yahweh, all you humble of the land, who have kept his ordinances. Seek righteousness. Seek humility. It may be that you will be hidden in the day of Yahweh's anger." | [Bible Hub WEB](https://biblehub.com/web/zephaniah/2.htm) | **Match, full verse** (blanked word "ordinances" confirmed present verbatim). |
...
| 5 | Zeph 3:15 | "Yahweh has taken away your judgments. He has thrown out your enemy. The King of Israel, Yahweh, is among you. You will not be afraid of evil any more." | [Bible Hub WEB](https://biblehub.com/web/zephaniah/3.htm) | **Match, full verse** (blanked word "judgments" confirmed present verbatim). |
...
Per this assignment's explicit instruction, grepped `docs/content/zephaniah-hard.md` directly for
...
exclusion-statement prose (the header note and the Contested Territory section) — no verse text,
recall blank, or challenge stem drawn from either range appears anywhere.** The claim in the brief
holds.

## Not re-litigated

Every verse in this brief was already double-sourced (ebible.org + biblegateway.com) in the brief
itself and in `docs/reviews/zephaniah-hard-review.md` §1. This pass adds a fresh, independent Bible
Hub fetch specific to this tier's brief, including on the more granular clauses this tier blanks
(e.g. "ruin" in 1:15, "Israel" in 3:14), and finds the same clean result.

## Conclusion

**`pass`.** All 6 challenge-ready verses, and every specific blanked word this tier's recall items
target, independently re-verified against Bible Hub with zero discrepancies. Both permanent
exclusions (Zephaniah 1:16-18, 2:4-15) independently reconfirmed absent by direct grep, not merely
taken on the brief's own claim. `docs/content/zephaniah-hard.md` is eligible for ingestion (pending
