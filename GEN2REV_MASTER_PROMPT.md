...
| 10 | Book-count expansion beyond the confirmed 14 | **Decided (2026-08-25): on hold, indefinitely**, pending real player/retention data — a deliberate call against the MVP's own ≤15-book guardrail, not a default. Do not add books 15+ in a future session without either Kachi explicitly reopening this or Phase 5 QA having run with real usage data to inform the call. See `MEMORY.md`'s 2026-08-25 "(later still)" entry. |
